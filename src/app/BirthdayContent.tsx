...
export default function BirthdayContent() {
  ...
  /* ── Autoplay: muted autoplay → unmute on ANY user interaction ── */
  useEffect(() => {
  ...
  return (
    <div suppressHydrationWarning>
      <style>{`
        ...
        body{background:var(--deep);font-family:'Lato',sans-serif;height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;position:relative;overflow:hidden;}
        /* bg image overlay */
        .bg-photo{position:fixed;inset:0;z-index:1;background:url('/gift/IMG_20200703_084725_1.jpg') center/cover no-repeat;opacity:.13;filter:blur(8px) saturate(1.4);transform:scale(1.08);}
        ...
        /* ── Layout wrapper ── */
        .page{position:relative;z-index:20;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;width:100%;gap:0;padding:12px 0 8px;}

        /* ── Card ── */
        .card{display:flex;flex-direction:column;align-items:center;gap:0;opacity:0;animation:cardIn 1.2s cubic-bezier(.22,1,.36,1) .6s forwards;width:min(92vw,420px);}
        @keyframes cardIn{from{opacity:0;transform:translateY(30px) scale(.95);}to{opacity:1;transform:translateY(0) scale(1);}}

        .flower-crown{font-size:clamp(1rem,4vw,1.4rem);letter-spacing:6px;opacity:0;animation:fadeUp .8s ease 1.4s forwards;filter:drop-shadow(0 0 10px rgba(255,110,180,.7));}

        .photo-wrap{position:relative;margin:8px 0 0;opacity:0;animation:fadeUp .9s ease 1.6s forwards;}
        .photo-frame{width:clamp(110px,22vw,150px);height:clamp(110px,22vw,150px);border-radius:50%;border:3px solid transparent;background:linear-gradient(var(--deep),var(--deep)) padding-box,linear-gradient(135deg,var(--gold),var(--rose),var(--purple),var(--gold)) border-box;display:flex;align-items:center;justify-content:center;position:relative;box-shadow:0 0 30px rgba(255,110,180,.4),0 0 60px rgba(199,125,255,.2);animation:pulseGlow 3s ease-in-out 2.5s infinite;}
        ...
        .name-tag{margin-top:10px;text-align:center;opacity:0;animation:fadeUp .9s ease 1.9s forwards;}
        .name-tag .label{font-family:'Lato',sans-serif;font-weight:300;font-size:clamp(.6rem,2vw,.7rem);letter-spacing:4px;text-transform:uppercase;color:var(--peach);opacity:.8;}
        ...
        .hb-line{margin-top:6px;text-align:center;opacity:0;animation:fadeUp .9s ease 2.1s forwards;}
        ...
        .divider{width:80%;height:1px;margin:10px auto;background:linear-gradient(90deg,transparent,var(--rose),var(--gold),var(--purple),var(--rose),transparent);opacity:0;animation:fadeIn .8s ease 2.3s forwards;}

        .wish{width:90%;text-align:center;color:rgba(255,230,245,.88);font-size:clamp(.75rem,2.8vw,.9rem);line-height:1.75;font-weight:300;letter-spacing:.3px;opacity:0;animation:fadeUp 1s ease 2.5s forwards;padding:0 4px;}

        .from-line{margin-top:10px;text-align:center;opacity:0;animation:fadeUp .9s ease 2.8s forwards;}
        ...
        .bottom-crown{font-size:clamp(1rem,4vw,1.3rem);letter-spacing:4px;margin-top:6px;opacity:0;animation:fadeIn 1s ease 3s forwards;filter:drop-shadow(0 0 8px rgba(255,110,180,.6));}

        /* Gift button */
        .gift-btn{margin-top:12px;opacity:0;animation:fadeUp 1s ease 3.2s forwards;}
        ...
        /* Music hint */
        .music-hint{position:fixed;bottom:14px;left:50%;transform:translateX(-50%);z-index:100;color:rgba(255,255,255,.35);font-size:.7rem;letter-spacing:2px;pointer-events:none;opacity:0;animation:fadeIn 1s ease 3.5s forwards;}

        /* Mute btn */
        .mute-btn{position:fixed;top:14px;right:14px;z-index:100;background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.2);color:#fff;border-radius:50%;width:40px;height:40px;font-size:1.2rem;cursor:pointer;backdrop-filter:blur(8px);transition:background .2s;}
        ...
        .slide-wrap{position:relative;width:100%;aspect-ratio:4/3;border-radius:14px;overflow:hidden;background:#0d0019;box-shadow:0 0 30px rgba(255,110,180,.2);}
        ...
        .close-btn{position:absolute;top:10px;right:13px;background:none;border:none;color:rgba(255,255,255,.6);font-size:1.5rem;cursor:pointer;line-height:1;transition:color .2s;}
      ...
      {/* Audio */}
      <audio ref={audioRef} src="/birthday.mp3" loop preload="auto" autoPlay muted />
          ...
          <div className="photo-wrap">
            ...
            <div className="photo-frame">
              <img
                src={PROFILE_IMG}
                alt="Kusha"
                style={{ width: 'calc(100% - 8px)', height: 'calc(100% - 8px)', borderRadius: '50%', objectFit: 'cover', display: 'block' }}
              />
            </div>
          </div>
